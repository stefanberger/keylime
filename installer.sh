...
case "$ID" in
    debian | ubuntu)
        ...
        BUILD_TOOLS="build-essential libtool automake pkg-config m4 libgcrypt20-dev uthash-dev autoconf autoconf-archive libcurl4-gnutls-dev gnulib doxygen libdbus-1-dev libjson-c-dev uuid-dev"
        NEED_BUILD_TOOLS=1
        $PACKAGE_MGR update
    ;;
    ...
    rhel | centos)
        case "${VERSION_ID}" in
            7)
                ...
                BUILD_TOOLS="openssl-devel file libtool make automake m4 libgcrypt-devel autoconf autoconf-archive libcurl-devel libstdc++-devel uriparser-devel dbus-devel gnulib-devel doxygen json-c-devel libuuid-devel"
                NEED_BUILD_TOOLS=1
            ...
            8|8.1|8.2|8.3)
                ...
                BUILD_TOOLS="git wget patch libyaml openssl-devel libtool make automake m4 libgcrypt-devel autoconf libcurl-devel libstdc++-devel dbus-devel json-c-devel libuuid-devel"
    ...
    fedora)
        ...
        BUILD_TOOLS="openssl-devel libtool make automake pkg-config m4 libgcrypt-devel autoconf autoconf-archive libcurl-devel libstdc++-devel uriparser-devel dbus-devel gnulib-devel doxygen json-c-devel libuuid-devel"
        GOPKG="golang"
